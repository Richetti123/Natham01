...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} MichiBot
  ${tradutor.texto1[2]} +5217771303481
  ...
  const Message = {
    document: { url: `https://whatsapp.com/channel/0029Vb5KnEv0wajldteZlH0G` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://whatsapp.com/channel/0029Vb5KnEv0wajldteZlH0G",
        mediaType: 2,
        previewType: "pdf",
        title: "The Mystic - Bot",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://whatsapp.com/channel/0029Vb5KnEv0wajldteZlH0G",
      },
    },
    caption: info,
    footer: wm,
